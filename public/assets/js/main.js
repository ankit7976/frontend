...
$(document).ready(function () {
	setTimeout(() => {
		$('.ec-main-menu ul li').addClass('dropdown position-static')
	}, 500)

	setTimeout(() => {
		$('.ec-main-menu ul li ul').addClass('mega-menu d-block')
	}, 600);

	setTimeout(() => {
		$('.ec-main-menu ul li ul li').removeClass('dropdown position-static').addClass('d-flex')
	}, 700);


	setTimeout(() => {
		$('.ec-main-menu ul li ul li ul').removeClass('mega-menu d-block');
		$('.ec-main-menu ul li .mega-menu li ').addClass('d-flex')
		$('.ec-main-menu ul li .mega-menu li ul').addClass('d-block')
		$('.ec-main-menu ul li .mega-menu li ul li').removeClass('d-flex')
